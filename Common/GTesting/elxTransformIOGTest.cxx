...
Expect_elx_TransformPoint_yields_same_point_as_ITK(const TITKTransform & itkTransform)
{
  ...
  elx::TransformIO::CopyParametersAndFixedParameters(*elxTransform, itkTransform);
...
GTEST_TEST(Transform, ITKTranslation2D)
{
...
GTEST_TEST(Transform, ITKTranslation3D)
{
...
GTEST_TEST(Transform, ITKAffine2D)
{
  constexpr auto Dimension = 2U;
...
GTEST_TEST(Transform, ITKAffine3D)
{
  constexpr auto Dimension = 3U;
...
GTEST_TEST(Transform, ITKEuler2D)
{
  constexpr auto Dimension = 2U;
...
GTEST_TEST(Transform, ITKEuler3D)
{
  constexpr auto Dimension = 3U;
